...
export default function Error({
  ...
  useEffect(() => {
    console.error("[v0] خطأ في صفحة المنشور:", error)
  }, [error])
  ...
  return (
    <div className="min-h-screen bg-[#F5E9E8] flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl p-8 max-w-md w-full text-center shadow-lg">
        ...
        <h2 className="text-xl font-bold text-[#B38C8A] mb-2">المنشور غير موجود</h2>
        <p className="text-gray-600 mb-6">عذراً، لم يتم العثور على المنشور المطلوب أو تم حذفه.</p>
