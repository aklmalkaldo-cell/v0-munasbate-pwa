...
export default function WeddingZaffatPage() {
  ...
  const loadServices = async () => {
    try {
      ...
      console.log("[v0] تم جلب زفات الزواج:", data)
      const filteredServices = data?.filter((s) => s.has_music === true) || []
      console.log("[v0] المقاطع بعد الفلترة (بموسيقى):", filteredServices)
    ...
    <div className="min-h-screen bg-[#F5E9E8] pb-20">
      ...
      <main className="pt-20 px-4 max-w-screen-xl mx-auto">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h1 className="text-2xl font-bold text-[#B38C8A]">زفات الزواج</h1>
        </div>
